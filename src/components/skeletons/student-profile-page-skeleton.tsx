...
const StudentProfilePageSkeleton = async () => {
  return (
    <div className="w-full flex flex-col items-center gap-5 pb-5">
      <StudentCardSkeleton title="General Details" />
      ...
      <WardenCardSkeleton title="Hostel & Warden Details" />
      <ParentCardSkeleton />
    </div>
  )
}

export default StudentProfilePageSkeleton
